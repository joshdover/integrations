...
Visit the Google Cloud Platform Integration page on your cluster and select the Integration Policies tab. Select the integration policy you previously created.
